...
var KitSlotAccessories = React.createClass({
	displayName: 'KitSlotAccessories',
	propTypes: {
	...
	render: function() {
		...
		return (
			React.createElement("table", {
					className: "table slot-item-accessories"
				},
...
var KitSlot = React.createClass({
	...
	render: function() {
		...
		if (accessories && accessories.length > 0) {
			accessoriesNode = React.createElement(KitSlotAccessories, {
		...
		return (
			React.createElement("a", {
				...
				React.createElement("div", {
					...
					React.createElement("div", {
						className: "slot-name"
					}, helpers.locale(this.props.slotName)),
					React.createElement("div", {
...
var KitOverview = React.createClass({
	displayName: 'KitOverview',
	propTypes: {
	...
	render: function() {
		...
		return (
			React.createElement("div", {
					className: "kit-overview column alpha"
				},
				rowNodes
			)
		);
