	...
	render: function() {
		...
		return (
			React.createElement("div", {
				...
				React.createElement("div", {
					className: "progress-bar-inner info",
					style: style
				}),
				React.createElement("div", {
					className: "progress-bar-inner-difference",
					style: diffStyle
				})
			)
		);
...
var ItemBars = React.createClass({
	displayName: 'ItemBars',
	render: function() {
		...
		if (mobility > 0) {
			return (
				React.createElement("ul", {
						className: "item-stats-info"
					},
					React.createElement("li", null,
						React.createElement("div", {
							className: "left-col"
						}, helpers.locale("ID_WEB_COMMON_STATS_DAMAGE")),
						React.createElement("div", {
							className: "right-col-1"
						}, damage + diffDamage),
						React.createElement("div", {
							className: "right-col-2"
						}, React.createElement(Bar, {
							value: damage,
							diffValue: diffDamage
						}))
					),
					...
					React.createElement("li", null,
						React.createElement("div", {
							className: "left-col"
						}, helpers.locale("ID_WEB_COMMON_ACCURACY")),
						React.createElement("div", {
							className: "right-col-1"
					...
					React.createElement("li", null,
						React.createElement("div", {
							className: "left-col"
						}, helpers.locale("ID_WEB_COMMON_STATS_MOBILITY")),
						React.createElement("div", {
							className: "right-col-1"
						}, mobility + diffMobility),
						React.createElement("div", {
							className: "right-col-2"
						}, React.createElement(Bar, {
							value: mobility,
							diffValue: diffMobility
						}))
					),
					...
					React.createElement("li", null,
						React.createElement("div", {
							className: "left-col"
						}, helpers.locale("ID_WEB_COMMON_STATS_RANGE")),
						React.createElement("div", {
							className: "right-col-1"
						}, range + diffRange),
						React.createElement("div", {
					...
					React.createElement("li", null,
						React.createElement("div", {
							className: "left-col"
						}, helpers.locale("ID_WEB_COMMON_STATS_HANDLING")),
						React.createElement("div", {
							className: "right-col-1"
