...
var VehicleSelector = React.createClass({
	...
	render: function() {
			...
			rowNodes.push(
				React.createElement("a", {
					...
					React.createElement("div", {
						...
						React.createElement("div", {
								className: "loadout-item-picture-inner"
							},
							React.createElement("div", {
		...
		return (
			React.createElement("div", {
					className: "vehicle-selector column alpha"
				},
				rowNodes
			)
		);
