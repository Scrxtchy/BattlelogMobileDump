            ...
            firstRowNode = (
                React.createElement("tr", {className: "item-extended-stats"}, 
                    React.createElement("td", null, 
                        React.createElement("p", {className: "title"}, helpers.locale("ID_WEB_PROFILE_STATS_RATEOFFIRE")), 
                        React.createElement("p", null, rateOfFire)
                    ), 
                    React.createElement("td", null, 
                        React.createElement("p", {className: "title"}, helpers.locale("ID_COMMON_FIREMODES")), 
