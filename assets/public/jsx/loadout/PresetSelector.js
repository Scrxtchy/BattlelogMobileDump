...
var PresetSlot = React.createClass({
	displayName: 'PresetSlot',
	render: function() {
		...
		if (this.props.isMyLoadout) {
			setActivePresetNode = (
				React.createElement("button", {
						...
						onClick: this.handleSetActivePresetBtnClick
					},
...
var PresetLocked = React.createClass({
	displayName: 'PresetLocked',
	render: function() {
		var isPremium = this.props.preset.lock.source === "premium_battlepack";

		var contentNode = React.createElement("p", {
			className: "generic-lock"
		}, helpers.locale("ID_WEB_LOADOUT_PRESET_LOCKED_REASON_GENERIC"));

		if (this.props.preset.lock.source === "battlepack") {
			contentNode = React.createElement("p", {
				className: "generic-lock"
			}, helpers.locale("ID_WEB_LOADOUT_PRESET_LOCKED_REASON_BATTLEPACK"));
		} else if (isPremium) {
			contentNode = React.createElement("p", {
				className: "generic-lock"
			}, helpers.locale("ID_WEB_LOADOUT_PRESET_LOCKED_REASON_PREMIUM_BATTLEPACK"));
