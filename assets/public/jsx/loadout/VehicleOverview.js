...
var VehicleSlot = React.createClass({
	displayName: 'VehicleSlot',
	render: function() {
...
var VehicleOverview = React.createClass({
	displayName: 'VehicleOverview',
	propTypes: {
	...
	render: function() {
		...
		if (!this.props.vehicle) {
			return React.createElement("div", {
				className: "vehicle-overview column"
			});
		}
