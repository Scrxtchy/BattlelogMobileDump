...
var ItemAccessoryListRow = React.createClass({
	displayName: 'ItemAccessoryListRow',
	statics: {
		...
		return (
			React.createElement("a", {
				...
				React.createElement("div", {
					...
					React.createElement("div", {
							className: "slot-item-image-wrapper"
						},
						React.createElement("div", {
					...
					React.createElement("div", {
						className: "slot-name"
					}, helpers.locale(this.props.accessory.name)),
					React.createElement("div", {
						className: "slot-item-name"
					}, helpers.locale(this.props.accessory.item.name))
				)
			)
		);
	}
...
var ItemAccessoryList = React.createClass({
	displayName: 'ItemAccessoryList',
	...
	render: function() {
		...
		if (accessories.length < this.props.minSlotsCount) {
			for (var i = 0; i < (this.props.minSlotsCount - accessories.length); i++) {
				accessoryNodes.push(React.createElement(ItemAccessoryListRow, {
					key: accessories.length + i
				}));
			}
		}
...
var ItemDetailsAccessoryPreview = React.createClass({
	displayName: 'ItemDetailsAccessoryPreview',
	render: function() {
		return (
			React.createElement("div", {
				...
				React.createElement("p", {
					className: "description"
				}, helpers.locale(this.props.accessory.description))
			)
		);
	}
});
...
var ItemOverview = React.createClass({
	displayName: 'ItemOverview',
	propTypes: {
	...
	render: function() {
		if (!this.props.presetItem) {
			return React.createElement("div", {
				className: "item-overview column"
			});
		}
			...
			if (this.props.previewAccessory) {
				...
				bodyNodes.push(
					React.createElement(ItemBars, {
							...
							diffData: viewItem.weaponData
						} // is either the previewItem or "selected/active" item
					)
				);
			...
			React.createElement("div", {
				...
				React.createElement("a", {
					...
					React.createElement("div", {
						...
						React.createElement("div", {
							className: "slot-item-name full-height"
						}, helpers.locale(viewPresetItem.name))
					)
				),
