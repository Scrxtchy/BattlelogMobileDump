...
var MessagesViewHeader = React.createClass({
	displayName: 'MessagesViewHeader',
	...
	render: function() {
		...
		var btnBack = (this.props.back) ? React.createElement("button", {
		...
		return React.createElement("div", {
			...
			React.createElement("button", {
				onClick: ChatStore.toggleMenu,
				className: "button menu"
			}, React.createElement("span", {
				className: "button-icon menu cog"
			})),
