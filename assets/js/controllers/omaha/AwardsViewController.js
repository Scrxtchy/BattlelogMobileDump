function AwardsViewController(e) {
	var t = "_activePersona",
		n = "persona",
		r = "_mysoldier";
	e = e || {}, this._section = "omaha", this._game = enums.Game.OMAHA, this._name = "AwardsView", this._templateParams = {
		loading: !0
	...
	}), this._model.fetch(this.get_url()), ScrollableViewController.call(this, e), this.titleSID = "ID_WEB_COMMON_STATS_COINS"
}
var app = require("app"),
	...
	json = require("gamedata/omaha/awards").mp,
